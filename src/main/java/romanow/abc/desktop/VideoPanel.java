...
public class VideoPanel extends javax.swing.JFrame {
    ...
    Component south;
    MediaPlayer player;
    public VideoPanel(String title, int x0, int y0, int ww, int hh, String path){
        super(title);
        setBounds(x0,y0,ww+40,hh+40);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VideoPanel("",200,200,640,480,"D:/FireFighter/FirefighterDataserver/temp.mpg");
                }
        });
    }
