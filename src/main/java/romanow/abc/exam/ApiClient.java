...
import romanow.abc.exam.auth.ApiKeyAuth;
import romanow.abc.exam.auth.OAuth;
import romanow.abc.exam.auth.OAuth.AccessTokenListener;
import romanow.abc.exam.auth.OAuthFlow;
...
public class ApiClient {
  ...
  public void createDefaultAdapter() {
    ...
    String baseUrl = "http://217.71.129.139";
    if (!baseUrl.endsWith("/"))
      baseUrl = baseUrl + "/";
